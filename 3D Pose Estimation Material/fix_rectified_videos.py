...
# Simple alternative in process_video function
def process_video_simple(video_path, calib_path, output_path):
    ...
    while True:
        ...
        rectified_frame = cv2.undistort(frame, mtx, dist, None, mtx)
...
def main():
    ...
    output_dir = "../video/fixed/rectified_rvecs_2nd" # folder path where to save the rectified videos
    ...
    for video_path in video_files:
        ...
        process_video_simple(video_path, calib_path, output_path)
